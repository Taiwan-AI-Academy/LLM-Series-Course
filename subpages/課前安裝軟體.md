...
- n8n 安裝
    - Windows
        ...
        2. Windows 按開始或放大鏡輸入 cmd 打開命令提示字元後輸入 npx n8n 安裝n8n / Mac 在終端機輸入 npx n8n 安裝n8n
            ...
            ![image.png](../assets/課前安裝軟體/image.png)
        ...
        - Windows
            ...
            **安裝順序：開啟Hyper-V →重新開機 → kubectl → minikube → n8n**
            ...
            1. 開啟 **Hyper-V**
                ...
                ![image.png](../assets/課前安裝軟體/image 1.png)
            ...
            2. 安裝 kubectl：
                ...
                ![Screenshot 2025-04-28 114035.png](../assets/課前安裝軟體/Screenshot_2025-04-28_114035.png)
            ...
            3. 顯示安裝版本資訊：
                ...
                ![image.png](../assets/課前安裝軟體/image 2.png)
            ...
            4. 安裝 minikube：到[https://github.com/kubernetes/minikube/releases](https://github.com/kubernetes/minikube/releases) 去下載 minikube-installer.exe 並執行安裝
                ...
                ![image.png](../assets/課前安裝軟體/image 3.png)
                
                ![image.png](../assets/課前安裝軟體/image 4.png)
            ...
            5. 啟動 minikube
                ...
                ![image.png](../assets/課前安裝軟體/image 5.png)
            ...
            6. 運行 minikube dashboard
                ...
                ![image.png](../assets/課前安裝軟體/image 6.png)
                
                打開 dashboard 指定網址
                
                ![image.png](../assets/課前安裝軟體/image 7.png)
            ...
            7. 使用 kubectl 指令可查看當前 cluster 資訊
                ...
                ![image.png](../assets/課前安裝軟體/image 8.png)
...
- FFmpeg
    ...
    ![image.png](../assets/課前安裝軟體/image 9.png)
    
    ![image.png](../assets/課前安裝軟體/image 10.png)
    ...
    ![image.png](../assets/課前安裝軟體/image 11.png)
    
    ![image.png](../assets/課前安裝軟體/image 12.png)
...
- Qdrant
    ...
    **Windows：**‣
    ...
    ![image.png](../assets/課前安裝軟體/image 13.png)
    
    - 執行 exe ，成功後如右圖
        
        ![image.png](../assets/課前安裝軟體/image 14.png)
    ...
    - UI 介面安裝：https://github.com/qdrant/qdrant-web-ui
        ...
        - 啟動 : npm start
            ...
            ![image.png](../assets/課前安裝軟體/image 15.png)
...
- Ｍiniconda
    ...
    ![image.png](../assets/課前安裝軟體/image 16.png)
